...
const genericMailboxTokens = new Set(["account", "accounts", "anonymous", "anonimo", "area", "branch", "care", "commercial", "commerciale", "commercialeitalia", "complaint", "complaints", "consumer", "consumerrelations", "customer", "customers", "customerservice", "direttore", "direzione", "editorial", "enquiry", "enquiries", "help", "imprese", "inquiry", "management", "manager", "media", "operations", "presidente", "redazione", "relations", "responsabile", "salesoffice", "service", "services", "vendite", "webmaster"]);
const nonPersonTokens = new Set("about advantage agency ai amministratore animalia area artificial azienda branch brands business certificazioni chief commission commerciale company consulente consulenza contact contacts corsi course country data delegato designer dettagli director direzione direttore ecommerce experience featured general group gruppo head hr innovation intelligence investor longevity management manager managing market marketing member nostre officer operator platform podcast posizionamento premio president presidente product prodotti professional project ready recruitment recruiting relazioni researcher responsabile retail sales security service servizi solution soluzioni specialist strategia strategie strategy suite talk team technology tocca toolkit ui ux valore vendite vice web webinar".split(" "));
