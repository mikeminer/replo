...
Il builder di ricerca su `replo.it` resta separato dalla monetizzazione API e non richiede invio dalla piattaforma. Su `replo.eu` le API sono offerte nei piani Startup (€7,90/mese, 1 chiave e 300 chiamate), Partner (€49,90/mese, 1 chiave e chiamate illimitate) ed Enterprise (€247,90/mese, chiavi etichettabili e chiamate illimitate).
